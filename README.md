# ****Strategy (전략)****
### 로고 설명 
- 목표를 이루기 위해선 계획과 전략이 필요하다. 그래서 전략이라는 뜻을 가진 영어단어 'Strategy'를 사용했고 영어발음 그대로 읽으면 어색한 면이 있어서 약간의 변형을 줘서 '스텔지'라고 정했다.
- 그리고 목표를 향해 나아간다는 느낌을 줄 수 있도록 화살표가 x 에서 o로 향하는 아이콘을 사용했다.
### App 한줄설명 
- 목표를 이루기 위한 나만의 전략!
--------------------------
## - App Logo
![Free_Sample_By_Wix (1)](https://user-images.githubusercontent.com/88191880/146191074-609756f3-fb40-4932-930a-ac346c93eee9.jpg)
...
## - App 간단 소개
    Strategy는 최종 목표를 위한 작은 목표들을 세우고, 작은 목표부터 차근차근 달성하다
    마침내 최종목표까지 달성하는 Plan 앱 입니다.
    TodoList, progressbar, D-day를 통해 나의 현재 상황을 직관적으로 볼 수 있습니다.
